...
Gem::Specification.new do |s|
  ...
  s.date = %q{2011-05-25}
  s.description = %q{Connect Capybara to remote Selenium servers}
  ...
  s.homepage = %q{http://github.com/Tho85/capybara-selenium-remote}
  s.licenses = ["MIT"]
  s.require_paths = ["lib"]
  s.rubygems_version = %q{1.3.7}
  s.summary = %q{Connect Capybara to remote Selenium servers}
